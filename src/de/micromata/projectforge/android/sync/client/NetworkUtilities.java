...
final public class NetworkUtilities {
	 ...
	 * @return Pair<String,String> The <userId, authentication token> returned
	 *         by the server (or null)
	...
	public static Pair<String, String> authenticate(String baseUrl,
		...
		urlBuilder.append("?").append(PARAM_USERNAME).append("=").append(URLEncoder.encode(username)).append("&").append(PARAM_PASSWORD).append("=").append(URLEncoder.encode(password));
