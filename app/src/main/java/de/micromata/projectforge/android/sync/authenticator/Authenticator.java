 ...
 * authenticating accounts in the de.micromata.projectforge.android.sync domain. The
...
//        String baseUrl = am.getUserData(account, "url");
//        if (password != null) {
//            final Pair<String,String> authToken = NetworkUtilities.authenticate(baseUrl, account.name, password);
//            if (authToken != null) {
//            	am.setUserData(account, "id", authToken.first);
//                final Bundle result = new Bundle();
//                result.putString(AccountManager.KEY_ACCOUNT_NAME, account.name);
//                result.putString(AccountManager.KEY_ACCOUNT_TYPE, Constants.ACCOUNT_TYPE);
//                result.putString(AccountManager.KEY_AUTHTOKEN, authToken.second);
//                return result;
//            }
//        }
